...
public enum ExcelRowExceptionType {
    ...
    NOT_EXIST_ALBUM_NAME(ExcelRowExceptionSeverityType.DANGER, "존재하지 않는 앨범명입니다."),
    NOT_EXIST_TRACK_NAME(ExcelRowExceptionSeverityType.DANGER, "존재하지 않는 트랙명입니다."),
    NOT_EXIST_ARTIST_NAME(ExcelRowExceptionSeverityType.DANGER, "존재하지 않는 아티스트명입니다."),
