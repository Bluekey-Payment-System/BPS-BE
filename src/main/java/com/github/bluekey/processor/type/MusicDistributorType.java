...
import com.github.bluekey.processor.provider.ThreePointOneFourDistributorExcelProvider;
import lombok.Getter;

@Getter
public enum MusicDistributorType {
    ATO("L2110A11_\\d{6}$", AtoDistributorExcelFileProvider.class),
    THREE_POINT_ONE_FOUR("^^\\d{6}-\\p{IsHangul}+$", ThreePointOneFourDistributorExcelProvider.class),
